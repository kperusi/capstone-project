...
import feedicon from "../../Assets/feeds/Vector.png";
    ...
    <main className="sidebar-main">
      ...
      <section className="sidebar-rw-2">
        ...
        <div className="sidebar-feed-div">
          ...
          <NavLink className="links">Bookmarks</NavLink>
        </div>
        ...
        <div className="sidebar-feed-div">
          ...
          <NavLink className="links">Team blogs</NavLink>
        </div>
        ...
        <div className="sidebar-feed-div">
          ...
          <NavLink className="links">Analytics</NavLink>
        </div>
      </section>
      ...
      <section className="sidebar-rw-3">
        ...
        <div className="sidebar-trending-div">
          <NavLink className="links">Programming</NavLink>
        </div>

        <div className="sidebar-trending-div">
          <NavLink className="links">Data science</NavLink>
        </div>

        <div className="sidebar-trending-div">
          <NavLink className="links">Technology</NavLink>
        </div>

        <div className="sidebar-trending-div">
          <NavLink className="links">Machine learning</NavLink>
        </div>

        <div className="sidebar-trending-div">
          <NavLink className="links">Politics</NavLink>
        </div>
        <div className="sidebar-trending-div">
          <NavLink className="links">See all</NavLink>
        </div>
      </section>
      ...
      <section className="sidebar-rw-4">
        ...
        <div className="sidebar-personal-div">
          ...
          <NavLink className="links">Account</NavLink>
        </div>
        ...
        <div className="sidebar-personal-div">
          ...
          <NavLink className="links">Nofification</NavLink>
        </div>
