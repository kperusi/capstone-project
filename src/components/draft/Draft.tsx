        ...
        {drafts.map((draft: any) => (
          <section key={draft.id} className="person-post-rw-1">
            ...
            <section className="person-post-rw-4">
              ...
              <div className="person-post-menu rounded-xl shadow border"></div>
            </section>
          </section>
        ))}
      </section>
...
//                             className="del-btn"
//                             onClick={() => {
//                               handleDelete(draft.id, draft.imageUrl);
//                               console.log("closed");
//                               close();
//                             }}
//                             style={{color:'red'}}
...
//                           className="del-btn"
//                           onClick={() => {
//                             handleEdit(draft.id, draft.imageUrl);
//                             close();
//                           }}
//                         >
//                           Edit Post
