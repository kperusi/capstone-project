      ...
      {post && (
        <main>
          ...
          <section className="single-post-rw-1">
            <div className="single-post-comment-cx">
              <div className="single-post-menu">
                <h1>Add your commits</h1>
                <form>
                  <input
                    type="text"
                    value={comment}
              ...
              <div className="comments-display">
                {post.comments.map((each) => (
                  <div className="comments-display-col-1">
                    <img src="" alt="profileImage" />
                    <div className="comment-rw-1">
                      <div className="comment-rw-2">
                        <h3>{each.commentBy}</h3>
                        <p>{each.createdAt.toDate().toDateString()}</p>
